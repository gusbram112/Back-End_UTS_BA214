    ...
    <div class="container clearfix" style="margin-top: 120px;">
        ...
        <div class="content">
            ...
            <form method="post" action="proses-edit-buku.php" enctype="multipart/form-data">
                ...
                <p><button type="button" onclick="document.getElementById('id01').style.display='none'" class="btn btn-signup"><a href="list-buku.php" style="color:white">Cancel</a></button></p>
            </form>
        </div>
